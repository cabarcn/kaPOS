    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('INVITADO', 'Invitado'), ('CLIENTE', 'Cliente'), ('CAPTADOR', 'Captador'), ('COORDINADOR_CAPTADORES', 'Coordinador de Captadores'), ('COORDINADOR_GENERAL', 'Coordinador General'), ('ENCARGADO_AREA', 'Encargado de Área'), ('SOPORTE', 'Soporte')], default='INVITADO', help_text='Rol del usuario en el sistema', max_length=30)),
